...
# CEREBRAS_API_KEY instead (or alongside). ANTHROPIC_API_KEY still works exactly as
# before if you do have a paid key — it's just no longer the ONLY fallback option.
...
# anthropic) last since owner keys are meant to be the free safety net.
