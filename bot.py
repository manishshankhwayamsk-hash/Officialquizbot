...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_verified:
        ...
        await send_typed(context.bot, update.effective_chat.id, verify_msg, parse_mode="Markdown", reply_markup=verification_keyboard())
        return
...
async def create_quiz_from_poll_data(bot, chat_id, question, options, correct_index, user_tag: str = '', explanation_tag: str = ''):
    ...
    await send_typed_poll_intro(bot, chat_id, question_text)
    await bot.send_poll(
        chat_id=chat_id,
